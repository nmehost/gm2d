...
class MultiDock extends Widget implements IDock implements IDockable
{
   ...
   public function new()
   {
      skin =  skin = Skin.create( "MultiDock", null, "" );
      flags = 0;
      mDockables = [];
      bestSize = [];
      tabStyle = false;
   ...
   override public function getClass() { return "MultiDock"; }
   ...
   public function setRect(x:Float,y:Float,w:Float,h:Float):Void
   {
      ...
      {
         currentDockable.setRect(mRect.x + itemX-layY,
                                 mRect.y + itemY-layY,
                                 mRect.width + layW-itemW,
                                 mRect.height + layH-itemH);
      }
   ...
   */
   ...
   function setCurrent(child:IDockable)
   {
      ...
      {
         currentDockable.setRect(itemX, itemY, itemW, itemH);
      }
