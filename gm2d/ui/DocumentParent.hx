...
class DocumentParent extends Sprite implements IDock implements IDockable
{
   ...
   public function getIcon(inPixelSize:Int):nme.display.BitmapData { return null; }
...
/*
   ...
   */
   ...
   public function redraw()
   {
      ...
      {
         if (gm2d.skin.Renderer.setFill(skin,gfx,skin.mdiFill,clientWidth,clientHeight))
            gfx.drawRect(0,0,clientWidth,clientHeight);
      }
