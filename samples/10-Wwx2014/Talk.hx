...
class Talk extends Sprite
{
   ...
   {
      var r =  (~/\b(\d+)\b/g).replace(inString,red+"$1"+o);
   ...
   function createTitle(inTitle,inSize=36.0)
   {
      ...
      layout.add( createTextLayout(inTitle,inSize)
               .setAlignment(Layout.AlignCenterX|Layout.AlignTop)
               );
